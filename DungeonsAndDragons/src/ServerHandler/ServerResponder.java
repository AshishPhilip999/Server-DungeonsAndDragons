...
public class ServerResponder {
    public static void sendResponse(ServerResponse response, Client clientData) throws Exception {
        // System.out.println();
        // System.out.println("[Server Responder:: sendResponse] Responding to " +
        // "[client ID: " +
        ...
        // System.out.println("[Server Responder] Sending request to clientID: " +
        // clientData.getClientID() + " of response type: " +
    ...
    public static void sendResponseToAllClients(ServerResponse response) {
        byte[] responseData = response.toByteArray();
        int responseLength = responseData.length;
    ...
    public static void sendResponseToAllOtherClients(ServerResponse response, Client currClient) {
        ...
        for (Map.Entry<UUID, OutputStream> client : ServerListener.clientConnections.entrySet()) {
            try {
                ...
                // System.out.println("[Server Responder:: sendResponseToAllOtherClients]
                // Sending request to clientID: "
                // + client.getKey());
